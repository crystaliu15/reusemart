...
<div class="max-w-md mx-auto mt-10 bg-white p-6 rounded shadow">
    ...
    <h2 class="text-xl font-bold mb-4">Login Penitip</h2>
    ...
    <!-- Form Login -->
    <form method="POST" action="{{ route('penitip.login') }}">
        @csrf
    ...
    <!-- Form Lupa Password -->
    <form method="POST" action="{{ route('penitip.lupa.password') }}">
        @csrf
    ...
    <p class="text-sm text-center mt-4">
        Belum punya akun?
        <a href="{{ route('penitip.register.form') }}" class="text-blue-600 hover:underline">
            Daftar dahulu
        </a>
    </p>
